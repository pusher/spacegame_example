 ...
 *
 * Modified by pusher.com for use with or without node.js
**/

;(function(exports, undefined) {

  var RAD = exports.RAD = Math.PI / 180.0;
  ...
  **/
  function extend(subc, superc, overrides) {
    ...
    if (overrides) {
      for (i in overrides) if (overrides.hasOwnProperty(i)) {
  ...
  **/
  ...
  Vector3D.prototype = {
   ...
   exports.calcNormalVector = calcNormalVector;
   exports.Vector = Vector;
   exports.Vector3D = Vector3D;

})((typeof exports !== 'undefined' ? exports : this['Vector']));
